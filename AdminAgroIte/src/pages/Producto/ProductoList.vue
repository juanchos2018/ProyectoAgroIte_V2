...
export default {
  data() {
    return {
      ...
      fields: [
        { label: "Codigo", key: "idProducto", sortable: false },
        
        { label: "Correo", key: "nombre_Producto", sortable: false },
        { label: "Imagen", key: "rutaImagen", sortable: false },
        { label: "Descripcion", key: "descripcion", sortable: false },
        { label: "Correo", key: "rutaImagen", sortable: false },
