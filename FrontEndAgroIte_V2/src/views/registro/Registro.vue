  ...
  <div class="container">
    ...
    <div class="form-row">
      <b-form-group label="Nombre:" class="col-md-4">
        <b-form-input v-model="Nombres" type="text" required></b-form-input>
      </b-form-group>
      ...
      <b-form-group label="Correo:" class="col-md-4">
        <b-form-input v-model="Correo" type="email" required></b-form-input>
      </b-form-group>
    </div>

    <div class="form-row">
      <b-form-group label="Direccion:" class="col-md-4">
        <b-form-input v-model="Direccion" type="text" required></b-form-input>
      </b-form-group>
    ...
    <div class="form-row">
      <b-form-group label="iamgen:" class="col-md-4">
        <input
          type="file"
          id="files"
          ref="files"
      ...
      <b-form-group label="Usuario:" class="col-md-4">
        <b-form-input v-model="Alias" type="text" required></b-form-input>
      </b-form-group>
    ...
    <div class="form-row">
      <b-form-group label="Celular:" class="col-md-4">
        <b-form-input v-model="Celular" type="number" required></b-form-input>
      </b-form-group>
...
export default {
  ...
  methods: {
    ...
    Registar() {
      ...
      axios
        .post(this.RutaNetCore + "Usuario/SetUsuario", data, config)
        .then((response) => {
