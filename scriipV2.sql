...
-- Volcando datos para la tabla db_agroite.actividad: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla db_agroite.asociacion: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `asociacion` DISABLE KEYS */;
INSERT INTO `asociacion` (`IdAsociacion`, `Ruc`, `Razon_Social`, `Descripcion`, `Departamento`, `Provincia`, `Direccion`, `Telefono`, `Representante`, `Integrantes`) VALUES
	(1, '555555', 'razon social', 'dese', 'tacna', 'tacna', 'direccion', '5858585', 'juan', 13);
...
-- Volcando datos para la tabla db_agroite.categoria: ~1 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  KEY `FK_Producto_Asociacion` (`IdAsociacion`),
  CONSTRAINT `FK_Producto_Asociacion` FOREIGN KEY (`IdAsociacion`) REFERENCES `asociacion` (`IdAsociacion`),
...
-- Volcando datos para la tabla db_agroite.producto: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `producto` DISABLE KEYS */;
INSERT INTO `producto` (`IdProducto`, `IdCategoria`, `Nombre_Producto`, `Precio_Referencial`, `Imagenes_Producto`, `RutaImagenes_Producto`, `Descripcion_Producto`, `Fecha_Inicio`, `Fecha_Fin`, `Cantidad_Producida`, `IdUnidad_Volumen`, `Idfrecuencia`, `IdUsuario`, `Cantidad_Minima`, `IdAsociacion`, `Cantidad_Maxima`) VALUES
	(1, 16, 'Ají Paprika ', 123, _binary '', 'img/product/16-ajip.png', 'El fruto de la páprika es de color rojo cuando esta madura, mide alrededor de 12 cm, posee un peculiar aroma muy agradable y un sabor característico no picante.', '2021-04-30', '2021-05-01', 12, 16, 16, 16, NULL, 1, NULL),
	(2, 16, 'Ají Negro pacae', 12, _binary '', 'img/product/16-images.jpg', 'El ají panca o ají colorado es un ají originario de Perú donde es muy utilizado en la gastronomía del país. Esta guindilla es menos picante en comparación con otras guindillas.', '2021-04-28', '2021-05-21', 3, 16, 16, 16, NULL, 1, NULL),
	(3, 16, 'Ají amarillo pacae', 12, _binary '', 'img/product/16-61NpzK1aWyL._SY445_.jpg', 'El aji amarillo tiene en realidad un color naranja intenso al madurar, tiene un toque picante al final. Tiene un sabor único afrutado.', '2021-05-05', '2021-05-08', 12, 16, 16, 16, NULL, 1, NULL),
	(4, 16, 'Granadilla', 12, _binary '', 'img/product/17-granadilla.jpg', 'La granadilla es una fruta oriunda de los andes peruanos, fue domesticada en la época preinca, su fruto es de cáscara frágil, en su interior aloja varias semillas comestibles y de agradable sabor.', '2021-05-12', '2021-05-22', 12, 16, 16, 17, NULL, 1, NULL),
	(5, 16, 'Cebolla', 12, _binary '', 'img/product/17-descarga.jpg', 'Allium cepa, comúnmente conocida como cebolla, es una planta herbácea bienal perteneciente a la familia de las amarilidáceas', '2021-05-12', '2021-05-22', 12, 16, 16, 17, NULL, 1, NULL),
	(6, 16, 'Ají Negro pacae', 12, _binary '', 'img/product/17-arx1288790081b.jpg', 'El ají panca o ají colorado es un ají originario de Perú donde es muy utilizado en la gastronomía del país. Esta guindilla es menos picante en comparación con otras guindillas.', '2021-05-19', '2021-05-20', 12, 16, 16, 17, NULL, 1, NULL),
	(7, 16, 'prroudcto 1', 12, _binary '', 'img/product/16-ELIZABETHaredem.png', 'descrpcion', '2021-11-23', '2021-12-04', 9, 16, 16, 16, 3.00, 1, 3.00);
...
-- Volcando datos para la tabla db_agroite.usuario: ~9 rows (aproximadamente)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`IdUsuario`, `IdActividad`, `Nombres`, `Apellidos`, `Tipo_Documento`, `Num_Identificacion`, `RutaFoto_Perfil`, `Celular`, `Direccion`, `Correo`, `Contraseña`, `Organizacion`, `Descripcion`) VALUES
	(16, 1, 'Walter', 'Flores Murillo', 0, '457138751', 'img/user/457138751-Clients.png', '970780836', 'Ite. Jorge Basadre. Tacna. Pampa baja', 'murillo@gmail.com', '123456', 'La Asociación De Agricultores 5 Estrellas, Distrito De Ite', 'Productor  de Ají negro  y ají amarillo'),
	(17, 1, 'jorgito', 'Curo Gallegos', 0, '45713875', 'img/user/45713875-loguusu1.png', '970780836', 'Ite. Jorge Basadre. Tacna. Pampa alta', 'gallegos@gmail.com', '123456', 'La Asociación De Agricultores 5 Estrellas, Distrito De Ite', 'Productor  de granadilla  y aji'),
	(18, 1, 'Daniel Luza', 'Bertín Pampa', 1, '46412032', 'img/user/46412032-85080724_435064617210623_7723333246775197696_o.jpg', '975941200', 'Ite. Jorge Basadre. Tacna. Pampa baja', 'bertin@gmail.com', '123456', 'La Asociación De Agricultores 5 Estrellas, Distrito De Ite', 'Productor  de Ají negro  y ají amarillo'),
	(19, 1, 'juan', 'panty', 1, '1111', 'img/user/1111-aveo.png', 'jcarlossenati@gmail.com', 'jcarlossenati@gmail.com', 'jcarlossenati@gmail.com', '', 'no', '+51970780836'),
	(20, 17, 'Virginia', 'gordis', 0, '45713875', 'img/user/45713875-Clients.png', '970780836', 'casa', 'virginagordis@gmail.com', '', 'no usa', 'descrip'),
	(21, 18, 'andrea', 'andrea', 1, '121212', 'img/user/121212-doc1.png', '1211', 'fdsds', 'jcarlossen22ati@gmail.com', '', 'no', '1111111'),
	(22, 18, 'pedero', 'pedero', 1, '45454545', 'img/user/45454545-carpeta1.png', '45713875', 'casera', 'jcarl222ossenati@gmail.com', '', 'no', '1111111'),
	(23, 16, 'aaaaaaaaa', 'aaaaaaaaaa', 1, 'aaaaaaaa', 'img/user/aaaaaaaa-Clients.png', 'aa', 'aaaa', 'jca111rlossenati@gmail.com', '', 'no', '1111111'),
	(24, 16, 'dfdf', 'dfdfd', 1, 'sdfdfd', 'img/user/sdfdfd-doc1.png', '55555', 'casda', 'jcarlos111senati@gmail.com', '', 'no', '1111111');
